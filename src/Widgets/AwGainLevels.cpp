...
//void AwGainLevels::save(const QString& path)
//{
//
//}
...
//void AwGainLevels::init(const QString& lvlFilePath)
//{
//	m_lvlPath = lvlFilePath;
//	m_map.clear();
//	// file may NOT exists
//	if (QFile::exists(lvlFilePath)) 
//		m_map = AwUtilities::json::fromJsonFileToMap(lvlFilePath);
//	if (!m_map.isEmpty()) {
//
//	}
//}
...
void AwGainLevels::gainLevelsForChannel(int type, vec& levels, float& value)
{
	switch (type)
	{
	case AwChannel::EEG:
...
void AwGainLevels::gainLevelsForChannel(AwChannel *channel, vec& levels, float& value)
{
	gainLevelsForChannel(channel->type(), levels, value);
}


//void AwGainLevels::load(const QString& path)
//{
//
//}