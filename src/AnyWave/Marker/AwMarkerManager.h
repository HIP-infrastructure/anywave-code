...
//	void setMarkingTool(AwDockAddMarker *dock);  
	inline AwMarkerInspector *markerInspector() { return m_markerInspector; }
	
//	void showMarkingTool();
//	AwDockAddMarker *markingTool() { return m_dockMarkingTool; }
	void closeFile();
	void quit();
...
public slots:
	...
	void clear();
//	/** Export data marked by a list of markers **/
//	void exportMarkers(const AwMarkerList& markers);
	...
	void writeTriggerValues(const AwMarkerList& markers);
...
private:
	...
	QDockWidget *m_dock;
//	AwDockAddMarker *m_dockMarkingTool;
