...
public:
	...
	//QList<QSharedPointer<AwViewSetup>> viewSetups() { return m_ds; }
	...
	inline void addViewSettings(AwViewSettings* settings) { m_viewSettings << settings; }
public slots:
...
protected:
	...
	//QList<QSharedPointer<AwViewSetup>> m_ds;
