...
//void AwDataClient::requestData(AwChannelList *channels, AwMarker *marker, float downSampling, AwFilteringOptions *foptions)
void AwDataClient::requestData(AwChannelList *channels, AwMarker *marker, bool rawData)
{
	if (!m_isConnected)
		return;
//	emit needData(channels, marker, downSampling, foptions);
...
//void AwDataClient::requestData(AwChannelList *channels, float start, float duration, float downSampling, AwFilteringOptions *foptions)
...
//void AwDataClient::requestFiltering(AwChannelList *channels)
//{
//	if (!m_isConnected)
//		return;
//	emit filteringNeeded(channels);
//	m_mutexDataAvailable.lock();
//	m_wcDataAvailable.wait(&m_mutexDataAvailable);
//	m_mutexDataAvailable.unlock();
//}