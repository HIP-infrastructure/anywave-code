...
//	connect(client, SIGNAL(needData(AwChannelList *, float, float, float, AwFilteringOptions *)), this, SLOT(loadData(AwChannelList *, float, float, float, AwFilteringOptions *)));
//	connect(client, SIGNAL(needData(AwChannelList *, AwMarker *, float, AwFilteringOptions *)), this, SLOT(loadData(AwChannelList *, AwMarker *, float, AwFilteringOptions *)));
