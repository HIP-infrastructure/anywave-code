...
#if defined(LINUX)
#define FIFF_HAS_LONG
#endif
#if defined(HPUX) && OSMAJOR > 10
#define FIFF_HAS_LONG
#endif
...
} fiffTime;	/**< Accurate time stamps used in FIFF files.*/
...
} fiffId;	   /**< This is the file identifier */
