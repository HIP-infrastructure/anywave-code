...
int dehuffman16(unsigned char *in, int n, int *method, sraw_t *out)
{
  ...
  static sraw_t negmask[33] = {
    (sraw_t)0xffffffff, (sraw_t)0xfffffffe, (sraw_t)0xfffffffc, (sraw_t)0xfffffff8,
    (sraw_t)0xfffffff0, (sraw_t)0xffffffe0, (sraw_t)0xffffffc0, (sraw_t)0xffffff80,
    (sraw_t)0xffffff00, (sraw_t)0xfffffe00, (sraw_t)0xfffffc00, (sraw_t)0xfffff800,
    (sraw_t)0xfffff000, (sraw_t)0xffffe000, (sraw_t)0xffffc000, (sraw_t)0xffff8000,
    (sraw_t)0xffff0000, (sraw_t)0xfffe0000, (sraw_t)0xfffc0000, (sraw_t)0xfff80000,
    (sraw_t)0xfff00000, (sraw_t)0xffe00000, (sraw_t)0xffc00000, (sraw_t)0xff800000,
    (sraw_t)0xff000000, (sraw_t)0xfe000000, (sraw_t)0xfc000000, (sraw_t)0xf8000000,
    (sraw_t)0xf0000000, (sraw_t)0xe0000000, (sraw_t)0xc0000000, (sraw_t)0x80000000,
    (sraw_t)0x00000000
  };

  static sraw_t posmask[33] = {
    (sraw_t)0x00000000, (sraw_t)0x00000001, (sraw_t)0x00000003, (sraw_t)0x00000007,
    (sraw_t)0x0000000f, (sraw_t)0x0000001f, (sraw_t)0x0000003f, (sraw_t)0x0000007f,
    (sraw_t)0x000000ff, (sraw_t)0x000001ff, (sraw_t)0x000003ff, (sraw_t)0x000007ff,
    (sraw_t)0x00000fff, (sraw_t)0x00001fff, (sraw_t)0x00003fff, (sraw_t)0x00007fff,
    (sraw_t)0x0000ffff, (sraw_t)0x0001ffff, (sraw_t)0x0003ffff, (sraw_t)0x0007ffff,
    (sraw_t)0x000fffff, (sraw_t)0x001fffff, (sraw_t)0x003fffff, (sraw_t)0x007fffff,
    (sraw_t)0x00ffffff, (sraw_t)0x01ffffff, (sraw_t)0x03ffffff, (sraw_t)0x07ffffff,
    (sraw_t)0x0fffffff, (sraw_t)0x1fffffff, (sraw_t)0x3fffffff, (sraw_t)0x7fffffff,
    (sraw_t)0xffffffff
  };

  static sraw_t setbit[16] = {
    (sraw_t)0x0001, (sraw_t)0x0002, (sraw_t)0x0004, (sraw_t)0x0008,
    (sraw_t)0x0010, (sraw_t)0x0020, (sraw_t)0x0040, (sraw_t)0x0080,
    (sraw_t)0x0100, (sraw_t)0x0200, (sraw_t)0x0400, (sraw_t)0x0800,
    (sraw_t)0x1000, (sraw_t)0x2000, (sraw_t)0x4000, (sraw_t)0x8000
  };
