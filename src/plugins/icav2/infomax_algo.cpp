...
void ICA::runica(double *data, double *weights, int chans, int samples, double *bias, int *signs) {
...
void ICA::infomax(int m, int n, int nc)
{
	...
	arma::mat mweigths(weights, nc, m);
	arma::mat msphere(sphere, m, m);
