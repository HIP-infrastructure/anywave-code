...
#include "../../../../src/plugins/Correlation/correlation.h"
...
const QMetaObject Correlation::staticMetaObject = {
    { &AwProcess::staticMetaObject, qt_meta_stringdata_Correlation.data,
...
struct qt_meta_stringdata_CorrelationPlugin_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CorrelationPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CorrelationPlugin_t qt_meta_stringdata_CorrelationPlugin = {
    {
QT_MOC_LITERAL(0, 0, 17) // "CorrelationPlugin"
...
static const uint qt_meta_data_CorrelationPlugin[] = {
...
void CorrelationPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject CorrelationPlugin::staticMetaObject = {
    { &AwProcessPlugin::staticMetaObject, qt_meta_stringdata_CorrelationPlugin.data,
      qt_meta_data_CorrelationPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *CorrelationPlugin::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *CorrelationPlugin::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_CorrelationPlugin.stringdata0))
        return static_cast<void*>(const_cast< CorrelationPlugin*>(this));
    if (!strcmp(_clname, "AnyWave.ProcessPluginInterface"))
        return static_cast< AwProcessPlugin*>(const_cast< CorrelationPlugin*>(this));
    return AwProcessPlugin::qt_metacast(_clname);
}

int CorrelationPlugin::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_EXPORT_PLUGIN(CorrelationPlugin, CorrelationPlugin)
