...
class AW_GRAPHICS_EXPORT AwGraphicsItem : public QObject
{
	Q_OBJECT
public:
...
class AW_GRAPHICS_EXPORT AwGraphicsSignalDialog : public QDialog
{
public:
...
class AW_GRAPHICS_EXPORT AwBaseGraphicsMarkerItem : public AwGraphicsItem
{
public:
...
class AW_GRAPHICS_EXPORT AwGraphicsCursorItem : public AwGraphicsItem, public QGraphicsRectItem
{
	Q_OBJECT
public:
...
class AW_GRAPHICS_EXPORT AwGraphics2DPlotItem : public AwGraphicsSignalItem /*, public QGraphicsRectItem */
{
public:
...
class AW_GRAPHICS_EXPORT AwGraphicsWidgetItem : public AwBaseGraphicsSignalItem, public QGraphicsProxyWidget
{
public:
