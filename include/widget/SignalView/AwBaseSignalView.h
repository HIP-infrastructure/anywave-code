...
//
//////////////////////////////////////////////////////////////////////////////////////////
#ifndef AW_BASE_SIGNAL_VIEW_H
#define AW_BASE_SIGNAL_VIEW_H
#include <AwGlobal.h>
...
class AW_WIDGETS_EXPORT AwBaseSignalView : public AwDataClient
{
	Q_OBJECT
public:
	AwBaseSignalView(int flags = AwBaseSignalView::Default, AwViewSettings *settings = NULL, QObject *parent = 0);
	virtual ~AwBaseSignalView();
	// flags to configure the widgets
	// Default = full navigation 
	enum Flags { Default = 0, NoNavBar = 1, NoHScrollBar = 2, NoSettingsButton = 4, AllowMarking = 8, NoMarkerBar = 16, EnableMarking = 32,
	ViewAllChannels = 64, NoGainLevels = 128, NoNavButtons = 256, NoInfoLabels = 512
	};
